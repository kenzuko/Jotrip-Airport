...
(function(){
  ...
  const D={
    vi:{
      ...
      searchPh:'Tìm số chuyến, hãng hoặc nơi đi/đến: VJ339, Hà Nội, Da Nang...',opsWatch:'Operation Watch',quickKicker:'OPERATIONS WATCH',scheduleWord:'lịch',nextArrivals:'Next Arrivals',dataHealth:'Data Health',
    ...
    en:{
      ...
      searchPh:'Search flight, airline or city: VJ339, Hanoi, Da Nang...',opsWatch:'Operation Watch',quickKicker:'OPERATIONS WATCH',scheduleWord:'sched',nextArrivals:'Next Arrivals',dataHealth:'Data Health',
      live:'LIVE',history:'HISTORY',analytics:'ANALYTICS',flights:'Flights',refresh:'Refresh',
    ...
    ko:{
      ...
      searchPh:'편명, 항공사 또는 도시 검색: VJ339, Hanoi, Da Nang...',opsWatch:'Operation Watch',quickKicker:'OPERATIONS WATCH',scheduleWord:'예정',nextArrivals:'다음 도착편',dataHealth:'데이터 상태',
    ...
    ru:{
      ...
      searchPh:'Поиск по рейсу, авиакомпании или городу: VJ339, Hanoi, Da Nang...',opsWatch:'Operation Watch',quickKicker:'OPERATIONS WATCH',scheduleWord:'расп.',nextArrivals:'Ближайшие прибытия',dataHealth:'Состояние данных',
    ...
    zh:{
      ...
      searchPh:'搜索航班、航空公司或城市：VJ339、Hanoi、Da Nang...',opsWatch:'Operation Watch',quickKicker:'OPERATIONS WATCH',scheduleWord:'计划',nextArrivals:'即将到达',dataHealth:'数据状态',
  ...
  function applyStatic(){
    ...
    qa('.operation-watch-title').forEach(el=>el.textContent=t('opsWatch'));qa('.operation-watch-kicker').forEach(el=>el.textContent=t('quickKicker'));set('#dataHealthCard .side-head h3',t('dataHealth'));
