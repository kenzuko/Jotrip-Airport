...
(function(){
  ...
  const D={
    vi:{
      ...
      market:'Thị trường',scheduleCompare:'So với lịch',checkinCounter:'Quầy làm thủ tục',checkinTime:'Giờ mở check-in',boardingGate:'Cửa ra máy bay',baggageBelt:'Băng chuyền hành lý',parking:'Vị trí đỗ',source:'Nguồn',trackFlight:'Theo dõi chuyến bay',openFr24:'Mở FR24 ↗',viewDetail:'Xem chi tiết',
    ...
    en:{
      ...
      market:'Market',scheduleCompare:'Vs schedule',checkinCounter:'Check-in counter',checkinTime:'Check-in opens',boardingGate:'Boarding gate',baggageBelt:'Baggage belt',parking:'Parking bay',source:'Source',trackFlight:'Flight tracking',openFr24:'Open FR24 ↗',viewDetail:'View details',
    ...
    ko:{
      ...
      market:'구분',scheduleCompare:'예정 대비',checkinCounter:'체크인 카운터',checkinTime:'체크인 시작',boardingGate:'탑승 게이트',baggageBelt:'수하물 벨트',parking:'주기장',source:'출처',trackFlight:'항공편 추적',openFr24:'FR24 열기 ↗',
    ...
    ru:{
      ...
      market:'Тип',scheduleCompare:'К расписанию',checkinCounter:'Стойка регистрации',checkinTime:'Начало регистрации',boardingGate:'Выход на посадку',baggageBelt:'Багажная лента',parking:'Место стоянки',source:'Источник',trackFlight:'Отслеживание рейса',openFr24:'Открыть FR24 ↗',
    ...
    zh:{
      ...
      market:'类型',scheduleCompare:'相对计划',checkinCounter:'值机柜台',checkinTime:'值机开始',boardingGate:'登机口',baggageBelt:'行李转盘',parking:'停机位',source:'来源',trackFlight:'航班追踪',openFr24:'打开 FR24 ↗',
